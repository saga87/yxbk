...
<script type="text/javascript">
       $(function (){
    	   ...
    	   $dialog = top.$("iframe[src='systemdev/module/perm_add.jsp']")[0].contentWindow;//用于关闭dialog
    	   ...
    	   $("#perm_uploadify").uploadify({
    	         ...
    	         'onUploadSuccess' : function(file, data, response) {  
    	              ...
    	              //realAddPerm(filename,0)
    	              $("input[name='perm_icon']").val(filename);
    	              $("input[name='module_id']").val(dialogData.content.module_id);
    	              var data = liger.get("perm_addWindow_form").getData();
    		          
    				  realAddPerm(data,top.$("iframe[src='wkrjsystemdev/wkrjModule/getPage.wk']")[0].contentWindow.$("#permissiongrid").ligerGetGridManager(),$dialog.parent.$.ligerDialog);
...
<!--添加菜单开始-->
<form id="perm_addWindow_form" method="post" class="liger-form">
    <div style="overflow:hidden;">
        ...
        <div style="overflow:hidden;">
            <div class="Co">
                <label>菜单图标:</label> <img style="display:none;" src="" id="perm_icon">

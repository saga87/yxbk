...
var func = function(ctt,id) {
    				var sum = ctt.length;
                          ...
                          var path = ctt[i].coverpath;
                          	$("#"+id).append('<li> <a href="frontpage/books_detail.jsp?books_id='+ctt[i].books_id+'"> <img   src=' +path+ '  class="img_a " style="height: 25vh;"> <div class="text_name co_66 fs_14"><p class="co_387 font_s18">'+ctt[i].books_name+'</p><p>作者:'+ctt[i].books_author+'</p><p>出版社：'+ctt[i].publishinghouse+'</p><p>出版日期：'+ctt[i].publishing_time+'</p></div></a></li>');
		...
		$(function (){
			...
			$.ajax({
               url: "front/web/books/getSecondData",
			...
			$.ajax({
                    ...
                    success: function(res){        
                          ...
                          for (var i = 0; i < res.length; i++) {
                          	$("#books_ul").append('<li> <a href="frontpage/books_detail.jsp?books_id='+res[i].books_id+'"> <img   src=' +res[i].coverpath+ '  class="img_a " style="height: 31vh;"> <div class="text_name co_66 fs_14"><p class="co_387 font_s18">'+res[i].books_name+'</p><p>作者:'+res[i].books_author+'</p><p>出版社：'+res[i].publishinghouse+'</p><p>出版日期：'+res[i].publishing_time+'</p></div></a></li>');
        ...
        <div class="main_top clearfix">
            <div class="main_top_fl main_width fl" id="topdiv">
                  <div class="fl_top fs fcolor clearfix">
                      <div class="fl_top_fl fl" id="changename">图书百科</div>
                       <div class="fl_top_fr fr">
                          <a href="frontpage/books_more.jsp?data_id=<%=data_id%>" class="fcolor">
                              更多>>
                          </a>
                      </div>
                  </div>
                 <div class="fl_top_main">
                    <ul class="top_main_ul clearfix" id="books_ul">
                   </ul>
            	</div>
            </div>
    </div>

...
.layui_nav .li_item{line-height: 80px}
  ...
  <% 
 String books_name = (String)request.getParameter("books_name");
	%>
...
var books_name = '<%=books_name%>';
  ...
  var pernum = 10;
  	...
  	$(function (){
			...
			$("#bookstypename").text(books_name+"  的搜索结果");
  	...
  	$.ajax({
		...
		$.ajax({
               url: "front/web/books/searchBooks",
               data: {page:1,rows:pernum,books_name:books_name},
               dataType : "json",  
               type : "POST",
               success: function(ctt){        
               		var sum = ctt.length;
                     ...
                     for (var i = 0; i < sum; i++) {
                     	...
                     	$("#con").append('<li class="clearfix "> <a class="box_right_text d_inb wid_79 co_33 font_s20 " href="frontpage/books_detail.jsp?books_id='+cid+'" >'+ctt[i].books_name+'</a></li>');
                     	} 

		...
		$.ajax({
               ...
               success: function(ctt){        
                     ...
                     for (var i = 0; i < sum; i++) {
                     	...
                     	var cid = ctt[i].notice_id;
                     
                     	$("#con").append('<li class="clearfix"> <a class="box_right_text d_inb wid_79 co_33 font_s20 " href="frontpage/notice_detail.jsp?notice_id='+cid+'" >'+ctt[i].notice_title+'</a></li>');
                     	} 
    ...
    <div style="padding: 15px;" class="clearfix">
      ...
      <div class="clearfix">
        <div class="hei bac_38 font_s16 co_ff clearfix padd_20">
            <span id="noticelist">通知公告列表</span>
